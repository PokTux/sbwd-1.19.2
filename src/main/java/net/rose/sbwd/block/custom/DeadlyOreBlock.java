...
public class DeadlyOreBlock
        extends Block {
    private final IntProvider experienceDropped;

    public DeadlyOreBlock(AbstractBlock.Settings settings) {
        this(settings, ConstantIntProvider.create(0));
    }

    public DeadlyOreBlock(AbstractBlock.Settings settings, IntProvider experience) {
        super(settings);
