...
public class WhyAreHoesAProtectedJavaClass
     ...
     */
    protected static final Map<Block, Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>>> TILLING_ACTIONS = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK, Pair.of(WhyAreHoesAProtectedJavaClass::canTillFarmland, WhyAreHoesAProtectedJavaClass.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT_PATH, Pair.of(WhyAreHoesAProtectedJavaClass::canTillFarmland, WhyAreHoesAProtectedJavaClass.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT, Pair.of(WhyAreHoesAProtectedJavaClass::canTillFarmland, WhyAreHoesAProtectedJavaClass.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.COARSE_DIRT, Pair.of(WhyAreHoesAProtectedJavaClass::canTillFarmland, WhyAreHoesAProtectedJavaClass.createTillAction(Blocks.DIRT.getDefaultState())), Blocks.ROOTED_DIRT, Pair.of(itemUsageContext -> true, WhyAreHoesAProtectedJavaClass.createTillAndDropAction(Blocks.DIRT.getDefaultState(), Items.HANGING_ROOTS))));

    public WhyAreHoesAProtectedJavaClass(ToolMaterial material, int attackDamage, float attackSpeed, Item.Settings settings) {
